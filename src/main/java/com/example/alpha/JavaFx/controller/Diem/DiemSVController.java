...
//        Column_Loai;
        ...
        Column_ThiL1.setCellValueFactory(param -> {
            System.out.println(Diem.getRepository().getLanThiByMaSV(param.getValue().getMaSinhVien()));
            return new SimpleObjectProperty<>(Diem.getRepository().getLanThiByMaSV(param.getValue().getMaSinhVien()).get(0));
        });
//        Column_ThiL1;
//        Column_ThiL2;
//        Column_ThiL3;
